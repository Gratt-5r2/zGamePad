...
#pragma region arrow pad normal
    ...
    KEYRECORD_BEGIN
      ...
      ALLOWCONDITION   IsNotInInterface
    KEYRECORD_END
...
#pragma region button A (X dualshok) normal
    ...
    KEYRECORD_BEGIN
      ...
      ALLOWCONDITION   IsNotInTransform
    KEYRECORD_END
#pragma endregion
...
#pragma region triggers melee
    ...
    KEYRECORD_BEGIN
      ...
      ALLOWCONDITION   IsFightModeMelee
    KEYRECORD_END
...
#pragma region triggers range
    ...
    KEYRECORD_BEGIN
      COMBINATION GamePunch
      EMULATION   GetBinded( GAME_UP )
      ALLOWCONDITION   IsFightModeRange
    KEYRECORD_END
...
#pragma region other fight mode
    ...
    KEYRECORD_BEGIN
      ...
      ALLOWCONDITION   HasLockedTarget
    KEYRECORD_END
#pragma endregion
...
#pragma region button A (X dualshok) normal
    ...
    KEYRECORD_BEGIN
      COMBINATION ButtonCross
      EMULATION   KEY_RETURN // diff ~
      CONDITION   IsNotInTransform, IsInInterface
    KEYRECORD_END
#pragma endregion
